...
export namespace Browser {
    ...
    export namespace accessibilityFeatures {
         ...
         */
        const autoclick: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 51
         */
        const caretHighlight: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 85
         */
        const cursorColor: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 51
         */
        const cursorHighlight: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 90
         */
        const dictation: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 87
         */
        const dockedMagnifier: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 51
         */
        const focusHighlight: Browser.types.ChromeSetting<boolean>;
         ...
         * @platform ChromeOS only
         */
        const highContrast: Browser.types.ChromeSetting<boolean>;
         ...
         * @platform ChromeOS only
         */
        const largeCursor: Browser.types.ChromeSetting<boolean>;
         ...
         * @platform ChromeOS only
         */
        const screenMagnifier: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 51
         */
        const selectToSpeak: Browser.types.ChromeSetting<boolean>;
         ...
         * @platform ChromeOS only
         */
        const spokenFeedback: Browser.types.ChromeSetting<boolean>;
         ...
         * @platform ChromeOS only
         */
        const stickyKeys: Browser.types.ChromeSetting<boolean>;
         ...
         * @since Chrome 51
         */
        const switchAccess: Browser.types.ChromeSetting<boolean>;
         ...
         * @platform ChromeOS only
         */
        const virtualKeyboard: Browser.types.ChromeSetting<boolean>;
    }
    ...
    namespace _debugger {
        ...
        const onDetach: Browser.events.Event<(source: Debuggee, reason: `${DetachReason}`) => void>;
        /** Fired whenever debugging target issues instrumentation event. */
        const onEvent: Browser.events.Event<(source: DebuggerSession, method: string, params?: object) => void>;
    }
    ...
    export namespace extension {
         ...
         */
        const onRequest: Browser.events.Event<
         ...
         */
        const onRequestExternal: Browser.events.Event<
            | ((request: any, sender: runtime.MessageSender, sendResponse: (response: any) => void) => void)
            | ((sender: runtime.MessageSender, sendResponse: (response: any) => void) => void)
        >;
    }
    ...
    export namespace identity {
        ...
        const onSignInChanged: Browser.events.Event<(account: AccountInfo, signedIn: boolean) => void>;
    }
    ...
    export namespace permissions {
        ...
        const onRemoved: Browser.events.Event<(permissions: Permissions) => void>;

        /** Fired when the extension acquires new permissions. */
        const onAdded: Browser.events.Event<(permissions: Permissions) => void>;
    }
    ...
    */
    export namespace printing {
         ...
         */
        const onJobStatusChanged: Browser.events.Event<(jobId: string, status: `${JobStatus}`) => void>;
    }
    ...
    export namespace printingMetrics {
        ...
        const onPrintJobFinished: Browser.events.Event<(jobInfo: PrintJobInfo) => void>;
    }
    ...
    export namespace ttsEngine {
         ...
         * @since Chrome 131
         */
        const onInstallLanguageRequest: Browser.events.Event<(requestor: TtsClient, lang: string) => void>;

        /**
         * Fired when a TTS client requests the install status of a language.
         * @since Chrome 132
         */
        const onLanguageStatusRequest: Browser.events.Event<(requestor: TtsClient, lang: string) => void>;
        ...
        const onPause: Browser.events.Event<() => void>;
        ...
        const onResume: Browser.events.Event<() => void>;

        /** Called when the user makes a call to tts.speak() and one of the voices from this extension's manifest is the first to match the options object. */
        const onSpeak: Browser.events.Event<
        ...
        const onSpeakWithAudioStream: Browser.events.Event<
            (
                utterance: string,
        ...
        const onStop: Browser.events.Event<() => void>;

        /**
         * Fired when a TTS client indicates a language is no longer needed.
         * @since Chrome 132
         */
        const onUninstallLanguageRequest: Browser.events.Event<
